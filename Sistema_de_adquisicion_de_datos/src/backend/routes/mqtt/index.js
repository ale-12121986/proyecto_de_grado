...
const options = {
    ...
    host:'54.232.196.184',// 192.168.226.8  192.168.2.4    54.232.196.184   
...
var client = mqtt.connect('wss://54.232.196.184/mqtt', options); // 192.168.2.4  192.168.226.8   54.232.196.184
//Comunicacion mqtt
client.on('connect', () =>{
